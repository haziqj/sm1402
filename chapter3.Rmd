...
_Example: Two tetrahedral dice, each with faes labelled 1,2,3, and 4, are thrown and the scores noted, where the score is the sum of two nombers on which the dice land. Find the pdf of $X$, where $X$ is defined to be 'the score when two dice are thrown'._
...
- He showed how to converta problem stated verbally into a system of polynomial equations up to the 14th order.
]
