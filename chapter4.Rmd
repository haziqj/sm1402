...
_Example: An investoer has the choice of two out of four investments: $X_1$, $X_2$, $X_3$ and $X_4$. The profits (in BND 1,000 per annum) from these may be assumed to be indpendently distributed and:_
...
Let's sum of the ${}^4C_2=6$ possible pairwise combinations of normal r.v. Then calculate the $Z$ value. We want to maximise $P(Z>2)$ (the distribution which gives us the smallest $Z$ value).
...
<!-- ```{r, include = FALSE} -->
<!-- file_name <- paste0("file://", normalizePath("chapter4.html")) -->
